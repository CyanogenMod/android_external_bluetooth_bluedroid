...
static int parse_bluez_hid_sdp_records(const char* adapter_path, const char* bd_addr)
{
    ...
    btif_config_set_int("Remote", bd_addr, "ssrmintout", ssr_min_timeout);
    btif_config_set_int("Remote", bd_addr, "ssrmaxlat", ssr_max_lat);
    btif_config_set_int("Remote", bd_addr, "priority", HID_PAIRED_DEV_PRIORITY);
